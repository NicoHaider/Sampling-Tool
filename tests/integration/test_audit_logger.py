...
class TestLogUndoRedoReset:
    ...
    def test_log_undo_with_none_sample_id_marks_restored_empty(self, logger: AuditLogger) -> None:
    ...
    def test_log_redo_with_none_sample_id_marks_restored_empty(self, logger: AuditLogger) -> None:
